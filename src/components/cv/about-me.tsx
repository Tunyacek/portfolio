  ...
  return (
    <div className="max-w-[600px]">
      ...
      <p className="text-sm md:text-md">
        ...
        controller, or sleeping on the sofa with one of my favorite series
        playing in the background. I just love having fun. Doesn't matter if
        it's sports, adventures, or something totally new! 🛼 🏕️ 🏄 `}
      </p>
    </div>
  );
}
